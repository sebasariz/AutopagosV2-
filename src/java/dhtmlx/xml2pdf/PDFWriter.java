...
public class PDFWriter {
    ...
    public double headerImgHeight = 60;
    ...
    public void generate(String xml, HttpServletResponse resp, String context) {
    ...
    private void printPageNumbers() throws Exception {
        ...
        while (itr.hasNext()) {
            ...
            str = "Fecha:" + dateFormat.format(date) + " " + str;
    ...
    private void printHeader() throws Exception {
        ...
        if (header == true) {
            String fileName = pathToImgs + "/images/header.jpg";
