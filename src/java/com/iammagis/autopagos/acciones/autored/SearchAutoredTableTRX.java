 ...
 * @author Usuario
 */
public class SearchAutoredTableTRX extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        if (session != null) {
            ...
            ArrayList<Transaccion> transacciones = transaccionJpaController.getTransaccionesAutored(fechaInicial, fechaFinal); 
            jSONObject = DataGrid.getTransaccionesAutoredData(transacciones);
        } else {
