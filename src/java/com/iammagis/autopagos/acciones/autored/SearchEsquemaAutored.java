 ...
 */
public class SearchEsquemaAutored extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        if (session != null) {
            ...
            Usuario usuarioPapa = usuarioJpaController.findUsuario(36L);

            ArrayList<UsuarioHasUsuarioReferidosAutored> usuarioReferidosAutoreds = new ArrayList<>(usuarioPapa.getUsuarioHasUsuarioReferidosAutoredCollection1());
            for (UsuarioHasUsuarioReferidosAutored usuarioHasUsuarioReferidosAutored : usuarioReferidosAutoreds) {
                ...
                String texto = usuarioReferido.getNombre() + " " + usuarioReferido.getApellidos() + " (" + usuarioReferido.getEmail() + ")"
                        + " == Referidos: " + usuarioReferido.getUsuarioHasUsuarioReferidosAutoredCollection1().size();
