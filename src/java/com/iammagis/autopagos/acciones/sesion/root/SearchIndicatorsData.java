 ...
 */
package com.iammagis.autopagos.acciones.sesion.root;
 ...
 * @author Usuario
 */
public class SearchIndicatorsData extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        if (session != null) {
            ...
            ArrayList<Transaccion> transacciones = transaccionJpaController.getTransacciones(fechaInicial, fechaFinal);
            JSONObject jSONObjectGrid = DataGrid.getTransaccionesData(transacciones);
            jSONObject.put("grid", jSONObjectGrid);
            
            //buscamos los datos de la grafica 
            JSONObject jSONObjectGrafica = DataGrid.getGraphicTransactions(transacciones,fechaInicial,fechaFinal);
