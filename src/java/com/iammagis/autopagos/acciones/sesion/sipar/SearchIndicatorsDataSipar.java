 ...
 */
package com.iammagis.autopagos.acciones.sesion.sipar;
 ...
 * @author Usuario
 */
public class SearchIndicatorsDataSipar extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        if (usuario != null) {
            ...
            ArrayList<Transaccion> transacciones = transaccionJpaController.getTransaccionesSiparByConvenio(fechaInicial, fechaFinal, convenios.getIdconvenios());
            ...
            JSONObject jSONObjectGrafica = DataGrid.getGraphicTransactionsSipar(transacciones,fechaInicial,fechaFinal);
