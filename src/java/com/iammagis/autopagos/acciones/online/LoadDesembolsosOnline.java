 ...
 * @author Usuario
 */
public class LoadDesembolsosOnline extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        if (usuario != null) {
            ...
            ArrayList<Transaccion> transaccions = transaccionJpaController.getTransaccionesPagosOnline();
            jSONObject = DataGrid.getTransaccionesPagoOnline(transaccions);
        } else {
