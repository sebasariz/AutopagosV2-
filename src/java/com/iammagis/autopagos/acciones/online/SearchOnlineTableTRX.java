 ...
 * @author Usuario
 */
public class SearchOnlineTableTRX extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        if (session != null) {
            ...
            ArrayList<Transaccion> transacciones =transaccionJpaController.getTransaccionesOnline(fechaInicial,fechaFinal);
            jSONObject= DataGrid.getTransaccionesOnlineData(transacciones);
        } else {
