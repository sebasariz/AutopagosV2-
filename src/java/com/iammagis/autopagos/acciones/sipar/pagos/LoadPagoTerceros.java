 ...
 */
package com.iammagis.autopagos.acciones.sipar.pagos;
 ...
 */
public class LoadPagoTerceros extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        if (usuario != null) {
            String content = "/pages/sipar_pagos.jsp";
            ...
            request.setAttribute("tabla", DataGrid.getPagosGrid(facturas));
