 ...
 * @author Usuario
 */
public class EditPlantillaFactura extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        if (usuario != null) {
            ...
            FacturaTemplate facturaTemplateAnterior = facturaTemplateJpaController.findFacturaTemplate(id);
            ArrayList<Campo> campos = new ArrayList<>(facturaTemplateAnterior.getCampoCollection());
            ...
            facturaTemplateAnterior = facturaTemplateJpaController.findFacturaTemplate(id);
            facturaTemplateAnterior.setHtml(html);
            facturaTemplateAnterior.setNombre(nombre);

            facturaTemplateAnterior = facturaTemplateJpaController.edit(facturaTemplateAnterior);
            for (int i = 0; i < array.length(); i++) {
                JSONObject jSONObject1 = array.getJSONObject(i);
                Campo campo = new Campo();
                campo.setXls(jSONObject1.getString("xls"));
                campo.setReferencia(jSONObject1.getString("variable"));
                campo.setFacturaTemplateidfacturaTemplate(facturaTemplateAnterior);
