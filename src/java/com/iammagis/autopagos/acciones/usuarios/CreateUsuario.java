...
public class CreateUsuario extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        if (session != null) {
            ...
            Usuario usuarioCorreo = usuarioJpaController.emailExist(usuario);
            if (usuarioCorreo == null) {
                ...
                if (tipoUsuario.getIDTipoUsuario() == 2 || tipoUsuario.getIDTipoUsuario() == 3|| tipoUsuario.getIDTipoUsuario() == 5) {
                    ...
                    usuario.setConveniosIdconvenios(convenios);
                }
                ...
                usuario.setModuloCollection(modulos);
                ...
                String template = CorreoZoho.getTemplate(CorreoZoho.inscripcionTemplate); 
                ...
                template = template.replace("$emailComercio", usuario.getEmail());
                template = template.replace("$contrasenaUsuario", usuario.getPass());
                CorreoZoho correoZoho = new CorreoZoho("Bienvenido a AUTOPAGOS.CO", template, strings);
                correoZoho.run();
            } else {
                MessageResources messages = MessageResources.getMessageResources("com.iammagis.autopagos.resources");
                String message = messages.getMessage(request.getLocale(), "erros.usaurioregistrado");
