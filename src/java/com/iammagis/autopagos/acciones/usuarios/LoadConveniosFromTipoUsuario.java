 ...
 * @author Usuario
 */
public class LoadConveniosFromTipoUsuario extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        if (session != null) {
            ...
            ArrayList<Convenios> convenioses = new ArrayList<>();
            if (idTipoUsuario == 2) {
                //sipar
                convenioses = conveniosJpaController.getConveniosByTipo(1);
            } else if (idTipoUsuario == 3) {
                //online
                convenioses = conveniosJpaController.getConveniosByTipo(2);
            }else if (idTipoUsuario == 5) {
                //aliado
                convenioses = conveniosJpaController.getConveniosByTipo(4);
            }

            JSONArray array = DataGrid.getConveniosJsonArraySelect(convenioses);
            jSONObject.put("select", array);
        } else {
