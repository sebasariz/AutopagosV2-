...
<html>
            ...
            <div class="col-sm-12">
                <div class="page-title-box">
                    <ol class="breadcrumb pull-right">
                        ...
                        <li class="active">Módulo pagos - SIPAR</li>
                    </ol>
                    <h4 class="page-title">Resumen de tus pagos !</h4>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12">
                <div class="card-box"> 
                    <div class="col-lg-6" style="text-align:left;">
                        <button type="button"  class="btn btn-primary waves-effect w-md waves-light m-b-5 buttonAuto" data-toggle="modal" data-target="#crear-factura-modal"><i class="fa fa-plus"> </i> Crear Pago</button>
                        <button type="button" class="btn btn-danger waves-effect w-md waves-light m-b-5 buttonAuto" data-toggle="modal" data-target="#eliminar-factura-modal" ><i class="fa fa-minus"> </i> Eliminar Pago</button>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary waves-effect waves-light" onclick="inscribirPago()">Crear Pago</button>
                </div>
            </div>
        </div>
    </div><!-- /.modal -->
    ...
    <div id="eliminar-factura-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    <h4 class="modal-title">Eliminar Pagos</h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <p>Esta seguro que desea eliminar las pagos seleccionadas?</p>
                        </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default waves-effect" data-dismiss="modal">Cancelar</button>
                    <button type="button" onclick="eliminarPago()" class="btn btn-danger waves-effect waves-light">Eliminar Pagos</button>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="file" name="filePagos" class="form-control" required>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script type="text/javascript">
        ...
        var gridPagos = new dhtmlXGridObject('gridbox');
        gridPagos.setImagePath(".dhtmlx/codebase/imgs/");
        gridPagos.attachHeader("#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,,,");
        gridPagos.setHeader("Referencia,Fecha - Hora,Estado,Visto,Valor,Valor pagado,Fecha vencimiento,Email, Recordar,Pagar");//the headers of columns   
        gridPagos.setColAlign("center,center,center,center,center,center,center,center,center,center,center");       //the alignment of columns   
        gridPagos.setColTypes("ro,ed,ed,ed,ed,ed,ed,link,link,link");                //the types of columns  
        gridPagos.setColSorting("int,str,str,int,str,str,str,str,str,str,str");          //the sorting types   
        gridPagos.init();      //finishes initialization and renders the grid on the page
        gridPagos.enableMultiselect(true);
        gridPagos.attachEvent("onBeforeSelect", function (row, old_row) {
        ...
        gridPagos.attachEvent("onRowSelect", onselect);
        var data = <%=request.getAttribute("tabla")%>
        gridPagos.clearAll();
        gridPagos.parse(data, "json");
        ...
        $("#subirArchivoPlantilla").submit(function (e) {
            ...
            $.ajax({
                ...
                cache: false,
                data: formData,
                url: 'UpdatePagosTemplateForm.ap',
                contentType: false,
                processData: false,
                success: function (json) {
                    ...
                    if (json.error != null) {
                        ...
                        gridPagos.clearAll();
                        gridPagos.parse(json.tabla, "json");
                    }
                }
            });
        });
        ...
        function createPDF() {
            gridPagos.toPDF('PdfGenerator.ap', 'gray');
        }
        function createXLS() {
            gridPagos.toPDF('XlsGenerator.ap', 'gray');
        }
        function inscribirPago() {
