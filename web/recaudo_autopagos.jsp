                    ...
                    <div class="row">
                        <div style=" width:350px; margin:50px auto; text-align:center;">
                            <div class="card-box">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <form role="form" action="PagoSipar.ap" name="FacturaAutopagos" method="POST" onsubmit="return validarBanco()">
                                            <div class="form-group">
                                                <label class="control-label"  style="font-size:13px; font-weight:100; margin:10px 0;">Referencia:</label>
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i class="fa fa-barcode"></i></span>
                                                    <input type="text" name="nombre" class="form-control" value="<bean:write name="referencia"/>" placeholder="Referencia" readonly>
                                                    <input type="hidden" name="idfacturaAutopagos" value="<bean:write name="idfactura"/>" > 
                                                </div>
                                                <label class="control-label"  style="font-size:13px; font-weight:100; margin:10px 0;">Valor Factura:</label>
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i class="fa fa-money"></i></span>
                                                    <input type="text"  class="form-control" placeholder="Valor" readonly value="<bean:write name="valor"/>">
                                                </div>
                                                <label class="control-label" style="font-size:13px; font-weight:100; margin:10px 0;">Costo Transacción:</label>
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i class="fa fa-money"></i></span>
                                                    <input type="text"  class="form-control" name="comision" readonly placeholder="Costo transaccion" value="<bean:write name="comision"/>">

                                                </div>
                                                <label class="control-label"  style="font-size:13px; font-weight:100; margin:10px 0;">Total a pagar:</label>
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i class="fa fa-money"></i></span>
                                                    <input type="text"  class="form-control" name="total" readonly placeholder="Totel" value="<bean:write name="total"/>">
                                                </div>
                                                <div class="form-group">
