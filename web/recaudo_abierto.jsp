                                    ...
                                    <div class="col-md-12">
                                        <form role="form" action="Pago.ap" method="POST" name="Factura" onsubmit="return validarBanco()">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i class="fa fa-money"></i></span>
                                                    <input type="text"  class="form-control" readonly name="total" id="total" placeholder="Total" value="<bean:write name="total"/>">
                                                </div> 
                                                
                                                <label class="control-label"  style="font-size:13px; font-weight:100; margin:10px 0;">Email:</label>
                                                <div class="input-group">
